...
export class ScrymeController {
  ...
  @Post('customers')
  async registerCustomer(@Body() body: { name: string; email: string; phone?: string; zitadelUserId?: string }) {
  ...
  @Post('members')
  async createMember(@Body() body: { name: string; email: string; role: string }) {
  ...
  async createShift(@Param('memberId') memberId: string, @Body() body: { startTime: string; endTime: string }) {
  ...
  async addBreak(@Param('shiftId') shiftId: string, @Body() body: { startTime: string; endTime: string }) {
