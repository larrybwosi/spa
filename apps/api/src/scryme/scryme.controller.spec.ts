...
describe('ScrymeController Unit Tests', () => {
  ...
  describe('Customers', () => {
    ...
    it('should update a customer', async () => {
      ...
      mockScrymeService.updateCustomer.mockResolvedValue({ id: 'cust-1', ...dto });
  ...
  describe('Staff / Members', () => {
    it('should create a staff member', async () => {
      const dto = { name: 'Alice', email: 'alice@example.com', role: 'EMPLOYEE' };
  ...
  describe('Shifts & Breaks', () => {
    it('should create a shift', async () => {
      const dto = { startTime: '2026-10-10T08:00:00Z', endTime: '2026-10-10T16:00:00Z' };
      mockScrymeService.createShift.mockResolvedValue({ id: 'shift-1', ...dto });
    ...
    it('should add a break', async () => {
      const dto = { startTime: '2026-10-10T12:00:00Z', endTime: '2026-10-10T13:00:00Z' };
