...
export const FALLBACK_SERVICES: ServiceDetail[] = [
  // Massage Therapy
  {
    ...
    description:
      "A classic, deeply relaxing treatment utilizing long, flowing strokes to improve circulation and melt away everyday stress.",
    longDescription:
  ...
  },
  {
    ...
    category: "Massage Therapy",
    description:
      "Intensive therapy focusing on deeper muscle layers to relieve chronic tension and facilitate recovery.",
    longDescription:
      "Reclaim structural balance and release deep-seated physical strain. Our Deep Tissue Restoration utilizes slow, deliberate strokes and deep finger pressure to target the inner layers of your muscles, tendons, and fascia. It is especially beneficial for chronic aches, stiffness, and athletic recovery.",
    price: 165,
    duration: 60,
    priceOptions: [
    ...
    image:
      "https://images.unsplash.com/photo-1639162906614-0603b0ae95fd?w=500&auto=format&fit=crop",
    benefits: [
  ...
  },
  {
    ...
    category: "Massage Therapy",
    description:
      "Smooth, heated stones are gently glided over the body to warm musculature and induce a state of profound relaxation.",
    longDescription:
    ...
    duration: 90,
    image:
      "https://plus.unsplash.com/premium_photo-1683134302817-0d6ecfd05e7a?w=500&auto=format&fit=crop",
    benefits: [
  ...
  // Skin Care
  {
    ...
    category: "Skin Care",
    description:
      "A tailored treatment designed to hydrate, brighten, and refine your complexion, leaving you with a lasting, healthy glow.",
    longDescription:
      "Unveil your skin's natural luminosity. This premium botanical facial is custom-blended using seasonal active botanical extracts, natural enzymes, and high-potency antioxidants. It gently exfoliates, deeply hydrates, and triggers cellular renewal for a visibly bright, fresh, and hydrated complexion.",
    price: 175,
    duration: 60,
    image:
  ...
  },
  {
    ...
    category: "Skin Care",
    description:
      "An intensive facial targeting fine lines and loss of elasticity, incorporating lymphatic drainage and potent active serums.",
    longDescription:
  ...
  // Holistic Wellness
  {
    ...
    description:
      "Ancient pressure-point techniques applied to the feet to stimulate energy flow and encourage healing throughout the entire body.",
    longDescription:
      "Re-center your energy from the ground up. This holistic therapeutic ritual focuses on the feet, where hundreds of nerve endings and reflex zones correspond to your organs and body systems. Using precise thumb and finger techniques, we release blockages and promote natural self-healing.",
    price: 120,
    duration: 45,
    image:
  ...
  },
  {
    ...
    category: "Holistic Wellness",
    description:
      "A sensory journey utilizing custom-blended essential oils to elevate mood, reduce anxiety, and harmonize your spirit.",
    longDescription:
      "A fully immersive aromatherapy sensory ritual designed to restore emotional, mental, and physical equilibrium. We begin with a customized aromatic profile selection, utilizing 100% pure organic botanical essences to tailor a restorative light-to-medium touch full body oil massage.",
    price: 160,
    duration: 60,
    image:
